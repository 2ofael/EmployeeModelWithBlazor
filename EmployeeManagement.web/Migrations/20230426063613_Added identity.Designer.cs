...
namespace EmployeeManagement.web.Migrations
{
    ...
    [Migration("20230426063613_Added identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeModel.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EmployeeModel.Department", b =>
                {
            ...
            modelBuilder.Entity("EmployeeModel.Employee", b =>
                {
                    b.HasOne("EmployeeModel.Department", "Department")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EmployeeModel.ApplicationUser", null)
                        .WithMany()
